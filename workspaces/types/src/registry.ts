...
const defaultParsers: Record<number, PGParser<any>> = {
  ...
  [oids._xid]: parseIntArray, /*                      | 1011 | _xid         | */
  [oids._xid8]: parseBigIntArray, /*                  |  271 | _xid8        | */

  /* Native array types of the above                  |_oid__|_typname______| */
  [oids._bool]: parseBoolArray, /*                    | 1000 | _bool        | */
  [oids._bytea]: parseByteAArray, /*                  | 1001 | _bytea       | */
  [oids._int8]: parseBigIntArray, /*                  | 1016 | _int8        | */
  [oids._int2]: parseIntArray, /*                     | 1005 | _int2        | */
  [oids._int4]: parseIntArray, /*                     | 1007 | _int4        | */
  [oids._oid]: parseIntArray, /*                      | 1028 | _oid         | */
  [oids._json]: parseJsonArray, /*                    |  199 | _json        | */
  [oids._point]: parsePointArray, /*                  | 1017 | _point       | */
  [oids._float4]: parseFloatArray, /*                 | 1021 | _float4      | */
  [oids._float8]: parseFloatArray, /*                 | 1022 | _float8      | */
  [oids._circle]: parseCircleArray, /*                |  719 | _circle      | */
  [oids._timestamp]: parseTimestampArray, /*          | 1115 | _timestamp   | */
  [oids._timestamptz]: parseTimestampTzArray, /*      | 1185 | _timestamptz | */
  [oids._interval]: parseIntervalArray, /*            | 1187 | _interval    | */
  [oids._jsonb]: parseJsonArray, /*                   | 3807 | _jsonb       | */
...
} // TODO satisfies Record<OIDs[keyof OIDs], PGParser<any>>
